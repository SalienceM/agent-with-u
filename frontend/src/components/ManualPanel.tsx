...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '📦', title: '按仓库批量安装 Skill', summary: '市场选择一个来源，或选中该仓库的 Skill，点击「安装此仓库全部」。搜索只过滤显示，不会缩小此批次的安装范围。来源管理和版本元数据默认折叠，为列表与说明保留空间。', entry: '扩展 → 扩展市场 → 安装此仓库全部', keywords: '仓库 全装 批量 安装 市场 布局 运行准备 弹窗',
